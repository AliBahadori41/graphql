...
return [
    ...
    'schemas' => [
        'default' => [
            ...
            'mutation' => [
                \App\GraphQL\Mutations\Authentication\Login::class,
                \App\GraphQL\Mutations\Authentication\Register::class,
            ],
            // The types only available in this schema
            'types' => [
                'UsersType' => UsersType::class,
                'PostType' => PostType::class,
                \App\GraphQL\Types\Authentication\LoginType::class,
            ],
